...
public class WalkIngActivity extends NFCActivity {
	...
	private Logger log = Logger.getLogger(WalkIngActivity.class);
	...
	private void readCard(Intent intent) {
		try {
			...
			if (student.getStuCode() != null) {
				Intent intent2 = new Intent(WalkIngActivity.this, RunGradeInputActivity.class);
	...
	private void setListeners() {
		btnScan.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent1 = new Intent(WalkIngActivity.this, CaptureActivity.class);
		...
		btnStart.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(WalkIngActivity.this, RunMeteringActivity.class);
