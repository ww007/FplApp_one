...
public class BasketballActivity extends NFCActivity {
	...
	private Logger log = Logger.getLogger(BasketballActivity.class);
	...
	private void readCard(Intent intent) {
		try {
			...
			log.info("篮球运球读卡=>" + student.toString());
			...
			if (student.getStuCode() != null) {
				Intent intent2 = new Intent(BasketballActivity.this, RunGradeInputActivity.class);
	...
	private void setListeners() {
		btnScan.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent1 = new Intent(BasketballActivity.this, CaptureActivity.class);
				intent1.putExtra("className", Constant.BASKETBALL_SKILL + "");
		...
		btnStart.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (readStyle == 0) {
					Intent intent = new Intent(BasketballActivity.this, RunMeteringActivity.class);
