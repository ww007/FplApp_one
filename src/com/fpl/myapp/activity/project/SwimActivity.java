...
public class SwimActivity extends NFCActivity {
	...
	private Logger log = Logger.getLogger(SwimActivity.class);
	...
	private void readCard(Intent intent) {
		try {
			...
			if (student.getStuCode() != null) {
				Intent intent2 = new Intent(SwimActivity.this, RunGradeInputActivity.class);
