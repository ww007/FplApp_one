...
/**
 * Entity mapped to table WH_ROUND_RESULT.
 */
public class WhRoundResult {
    ...
    public WhRoundResult() {
    }

    public WhRoundResult(Long WhRoundResultID) {
        this.WhRoundResultID = WhRoundResultID;
    }

    public WhRoundResult(Long WhRoundResultID, String studentCode, String gradeCode, Integer sex, String hItemCode, String wItemCode, Integer hResult, Integer wResult, Integer RoundNo, String TestTime, Integer ResultState, String Mac) {
        this.WhRoundResultID = WhRoundResultID;
