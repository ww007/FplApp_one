...
/**
 * Entity mapped to table TOTAL_ROUND_RESULT.
 */
public class TotalRoundResult {
    ...
    private transient TotalRoundResultDao myDao;

    private StudentItem studentItem;
    private Long studentItem__resolvedKey;


    public TotalRoundResult() {
    }

    public TotalRoundResult(Long RoundResultID) {
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getTotalRoundResultDao() : null;
    }
