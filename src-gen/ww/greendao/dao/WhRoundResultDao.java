...
/** 
 * DAO for table WH_ROUND_RESULT.
*/
public class WhRoundResultDao extends AbstractDao<WhRoundResult, Long> {

    public static final String TABLENAME = "WH_ROUND_RESULT";

    /**
     * Properties of entity WhRoundResult.<br/>
    ...
    */
    ...
    public WhRoundResultDao(DaoConfig config) {
        super(config);
    }
    
    public WhRoundResultDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'WH_ROUND_RESULT' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'WH_ROUND_RESULT'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, WhRoundResult entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public WhRoundResult readEntity(Cursor cursor, int offset) {
        WhRoundResult entity = new WhRoundResult( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, WhRoundResult entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(WhRoundResult entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(WhRoundResult entity) {
        if(entity != null) {
