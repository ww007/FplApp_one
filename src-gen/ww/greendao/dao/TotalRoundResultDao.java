...
/** 
 * DAO for table TOTAL_ROUND_RESULT.
*/
public class TotalRoundResultDao extends AbstractDao<TotalRoundResult, Long> {

    public static final String TABLENAME = "TOTAL_ROUND_RESULT";

    /**
     * Properties of entity TotalRoundResult.<br/>
    ...
    */
    ...
    private Query<TotalRoundResult> studentItem_TotalRoundResultsQuery;

    public TotalRoundResultDao(DaoConfig config) {
        super(config);
    }
    
    public TotalRoundResultDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'TOTAL_ROUND_RESULT' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'TOTAL_ROUND_RESULT'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TotalRoundResult entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(TotalRoundResult entity) {
    ...
    /** @inheritdoc */
    @Override
    public TotalRoundResult readEntity(Cursor cursor, int offset) {
        TotalRoundResult entity = new TotalRoundResult( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TotalRoundResult entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TotalRoundResult entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TotalRoundResult entity) {
        if(entity != null) {
    ...
    /** Internal query to resolve the "totalRoundResults" to-many relationship of StudentItem. */
    public List<TotalRoundResult> _queryStudentItem_TotalRoundResults(Long StudentItemID) {
        synchronized (this) {
            if (studentItem_TotalRoundResultsQuery == null) {
                QueryBuilder<TotalRoundResult> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.StudentItemID.eq(null));
                studentItem_TotalRoundResultsQuery = queryBuilder.build();
            }
        }
        Query<TotalRoundResult> query = studentItem_TotalRoundResultsQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM TOTAL_ROUND_RESULT T");
    ...
    protected TotalRoundResult loadCurrentDeep(Cursor cursor, boolean lock) {
        TotalRoundResult entity = loadCurrent(cursor, 0, lock);
    ...
    public TotalRoundResult loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<TotalRoundResult> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<TotalRoundResult> list = new ArrayList<TotalRoundResult>(count);
    ...
    protected List<TotalRoundResult> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<TotalRoundResult> queryDeep(String where, String... selectionArg) {
